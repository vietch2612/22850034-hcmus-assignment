...
class AdjacencyMatrix {
    ...
    int count_vertices_by_condition(int so_dinh) {
        int count = 0;
    ...
    int count_pendant_vertices() { return count_vertices_by_condition(1); }
    int count_isolated_vertices() { return count_vertices_by_condition(0); }
...
public:
    ...
    void print_number_of_pendent_vertices() {
        std::cout << "So dinh treo: " << count_pendant_vertices() << std::endl;
    }

    void print_number_isolated_vertices() {
        std::cout << "So dinh co lap: " << count_isolated_vertices()
                  << std::endl;
    }
};
...
int main() {
    ...
    AM.print_number_of_pendent_vertices();
    AM.print_number_isolated_vertices();
    AM.print_degrees();
    AM.print_graph_type();
